...
public class AnamneseDAO implements IAnamneseDAO {
    ...
    public void adiciona(Anamnese anamnese){
        ...
        String sql = "insert into anamnese " +
                "(queixas, sintomas, tratamentos_anteriores, medicamentos, infancia, rotina, vicios, hobbies, trabalho, historico_familiar, comportamento, linguagem, humor, hipotese_diagnostica, observacoes, numero_sessoes, valor_sessao, periodicidade)" +
                " values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        try{
